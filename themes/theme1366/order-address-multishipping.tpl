...
{if !$opc}
  <p class="cart_navigation clearfix">
    ...
    {if $back}
      <a href="{$link->getPageLink('order', true, NULL, "back={$back}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-secondary btn-md icon-left">
        <span>{l s='Continue Shopping'}</span>
      </a>
    {else}
      <a href="{$link->getPageLink('order', true, NULL)|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-secondary btn-md icon-left">
        <span>{l s='Continue Shopping'}</span>
      </a>
    {/if}
    <button type="submit" name="processAddress" class="btn btn-secondary btn-md icon-right">
      <span>
...
{strip}
  ...
  {capture}
    <a class="btn-sm btn btn-secondary icon-right" href="{$smarty.capture.addressUrlAdd}" title="{l s='Update' js=1}">
      <span>
        {l s='Update' js=1}
      </span>
    </a>
