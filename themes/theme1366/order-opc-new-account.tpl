          ...
          {foreach from=$dlv_all_fields item=field_name}
            ...
            {elseif $field_name eq "city"}
              <div class="required form-group">
                ...
                <select name="city" id="city" class="form-control validate" data-validate="isCityName" value="{if isset($guestInformations) && isset($guestInformations.city) && $guestInformations.city}{$guestInformations.city}{/if}">
                  <option value="">-- Seleccione región --</option>
                  <option value="I" {if $address->city == 'I' } selected {/if}> I Región de Tarapacá</option>
                  <option value="II" {if $address->city == 'II' } selected {/if}> I I Región de Antofagasta</option>
                  <option value="III" {if $address->city == 'III' } selected {/if}> III Región de Atacama</option>
                  <option value="IV" {if $address->city == 'IV' } selected {/if}> IV Región de Coquimbo</option>
                  <option value="V" {if $address->city == 'V' } selected {/if}> V Región de Valparaíso</option>
                  <option value="VI" {if $address->city == 'VI' } selected {/if}> VI Región de O'Higgins</option>
                  <option value="VII" {if $address->city == 'VII' } selected {/if}> VII Región del Maule</option>
                  <option value="VIII" {if $address->city == 'VIII' } selected {/if}> VIII Región del Biobío</option>
                  <option value="IX" {if $address->city == 'IX' } selected {/if}> IX Región de la Araucanía</option>
                  <option value="X" {if $address->city == 'X' } selected {/if}> X Región de los Los Lagos</option>
                  <option value="XI" {if $address->city == 'XI' } selected {/if}> XI Región de Aysén</option>
                  <option value="XII" {if $address->city == 'XII' } selected {/if}> XII Región de Magallanes</option>
                  <option value="RM" {if $address->city == 'RM' } selected {/if}> Región Metropolitana</option>
                  <option value="XIV" {if $address->city == 'XIV' } selected {/if}> XIV Región de Los Ríos</option>
                  <option value="XV" {if $address->city == 'XV' } selected {/if}> XV Región de Arica y Parinacota</option>
                </select>
              </div>
