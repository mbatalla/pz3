...
{if $errors|@count == 0}
  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <div class="primary_block row">    
      ...
      <!-- center infos -->
      <div class="pb-right-column {if $columns == 2}col-xs-12 col-md-5 col-lg-6{elseif $columns == 3}col-xs-12 {elseif $content_only} col-md-6{else}col-sm-6 col-md-6 col-lg-6{/if}">
        ...
        {assign cat14 [['id_category' => 147]]}
        {if Product::idIsOnCategoryId($product->id_product, $cat14)}
          <span class="cybermonday-logo">Cybermonday</span>
        {/if}
        <h1 itemprop="name">
          {$product->name|escape:'html':'UTF-8'}</h1>
                ...
                <div id="product-attachments-tab-content" class="product-attachments-tab-content tab-pane">
                  {foreach from=$attachments item=attachment name=attachements}
                    ...
                    <div class="col-lg-6">
                      ...
                      <a class="btn btn-secondary-2 btn-sm" href="{$link->getPageLink('attachment', true, NULL, "id_attachment={$attachment.id_attachment}")|escape:'html':'UTF-8'}">
                      ...
                      <div class="functional-buttons clearfix">
                        {if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0) && isset($add_prod_display) && $add_prod_display == 1}
                          <div class="cart-btn no-print">
                            <a class="ajax_add_to_cart_button" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='Add to cart'}"></a>
                          </div>
                        {/if}
                      </div>
                    </li>
