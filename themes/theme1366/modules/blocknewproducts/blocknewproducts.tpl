...
<section id="new-products_block_right" class="block products_block">
  ...
  <div class="block_content products-block">
    {if $new_products !== false}
        ...
        {foreach from=$new_products item=newproduct name=myLoop}
          <li class="clearfix">
            ...
            <div class="product-content">
              ...
              <p class="product-description">{$newproduct.description_short|strip_tags:'UTF-8'|truncate:57:'...'}</p>
      ...
      <div>
        <a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='blocknewproducts'}" class="btn btn-secondary-2 btn-sm">
          <span>
