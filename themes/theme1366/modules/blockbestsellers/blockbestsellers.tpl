...
<section id="best-sellers_block_right" class="block products_block">
  ...
  <div class="block_content">
    {if $best_sellers && $best_sellers|@count > 0}
        ...
        {foreach from=$best_sellers item=product name=myLoop}
          <li class="clearfix">
            ...
            <div class="product-content">
              ...
              <p class="product-description">{$product.description_short|strip_tags:'UTF-8'|truncate:57:'...'}</p>
              {if !$PS_CATALOG_MODE}
                <div class="price-box">
      ...
      <div class="lnk">
        <a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='All best sellers' mod='blockbestsellers'}" class="btn btn-secondary-2 btn-sm">
          <span>
