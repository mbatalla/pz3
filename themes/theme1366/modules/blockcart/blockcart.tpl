<!-- MODULE Block cart -->
{if isset($blockcart_top) && $blockcart_top && $PS_CATALOG_MODE}
        ...
        <div class="block_content">
          ...
          <div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
                  ...
                  <dt data-id="cart_block_product_{$product.id_product|intval}_{if $product.id_product_attribute}{$product.id_product_attribute|intval}{else}0{/if}_{if $product.id_address_delivery}{$product.id_address_delivery|intval}{else}0{/if}" class="{if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if}">
                    ...
                    <div class="cart-info">
                      <div class="product-name">
                        ...
                        <a class="cart_block_product_name" href="{$link->getProductLink($product, $product.link_rewrite, $product.category, null, null, $product.id_shop, $product.id_product_attribute)|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}">{$product.name|truncate:25:'...'|escape:'html':'UTF-8'}</a>
                      </div>
            ...
            <div class="cart-prices">
              <div class="cart-prices-line first-line {if !($page_name == 'order-opc') && $shipping_cost_float == 0 && (!$cart_qties || $cart->isVirtualCart() || !isset($cart->id_address_delivery) || !$cart->id_address_delivery || $free_ship)} unvisible{/if}">
                  <span>
            ...
            <div class="bottom-wrapper">
              ...
              <p class="cart-buttons">
                <a id="button_order_cart" class="btn btn-secondary btn-sm" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
      ...
      <div class="layer_cart_cart col-xs-12 col-md-6">
        ...
        {if $show_wrapping}
          <div class="layer_cart_row">
            ...
            <strong class="price cart_block_wrapping_cost">
              {if $priceDisplay == 1}
        ...
        {/if}
        <div class="layer_cart_row">
          <span class="{if $shipping_cost_float == 0 && (!$cart_qties || $cart->isVirtualCart() || !isset($cart->id_address_delivery) || !$cart->id_address_delivery)} unvisible{/if}">
          ...
          <strong class="ajax_cart_shipping_cost{if $shipping_cost_float == 0 && (!$cart_qties || $cart->isVirtualCart() || !isset($cart->id_address_delivery) || !$cart->id_address_delivery)} unvisible{/if}">
            {if $shipping_cost_float == 0}
        ...
        {if $show_tax && isset($tax_cost)}
          <div class="layer_cart_row">
            <span>{l s='Tax' mod='blockcart'}</span>
            <strong class="price cart_block_tax_cost ajax_cart_tax_cost">{$tax_cost}</strong>
          </div>
        {/if}
        <div class="layer_cart_row">  
          <span>
        ...
        <div class="button-container">  
          <span class="continue btn btn-secondary btn-md" title="{l s='Continue shopping' mod='blockcart'}">
            <span>
