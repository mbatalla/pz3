                ...
                <div class="functional-buttons clearfix">
                  {if !$PS_CATALOG_MODE && ($related.allow_oosp || $related.quantity > 0)}
                    <div class="cart-btn no-print">
                      <a class="ajax_add_to_cart_button" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$related.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$related.id_product|intval}" title="{l s='Add to cart' mod='tmrelatedproducts'}">
