      ...
      {if $item.fade == '1'}{$item.fade = 'true'}{else}{$item.fade = 'false'}{/if}
        {foreach from=$item.child item=layout name=layout_info}
          ...
          {elseif $layout.type == 2}
            <div style="position: relative" class="rd-parallax-layer video-bg" data-offset="{$layout.offset|escape:'htmlall':'UTF-8'}" data-speed="{$layout.speed|escape:'htmlall':'UTF-8'}" data-type="media" data-fade="{$layout.fade|escape:'htmlall':'UTF-8'}" data-direction="{$layout.inverse|escape:'htmlall':'UTF-8'}">
          ...
          {elseif $layout.type == 3}
            <div class="rd-parallax-layer top-z-index" data-offset="{$layout.offset|escape:'htmlall':'UTF-8'}" data-speed="{$layout.speed|escape:'htmlall':'UTF-8'}" data-type="media" data-fade="{$layout.fade|escape:'htmlall':'UTF-8'}" data-direction="{$layout.inverse|escape:'htmlall':'UTF-8'}"><div class="text-layout {$layout.specific_class|escape:'htmlall':'UTF-8'}">{$layout.content}</div></div>
          {elseif $layout.type == 4}
            <div class="rd-parallax-layer video-bg" data-offset="{$layout.offset|escape:'htmlall':'UTF-8'}" data-speed="{$layout.speed|escape:'htmlall':'UTF-8'}" data-type="media" data-fade="{$layout.fade|escape:'htmlall':'UTF-8'}" data-direction="{$layout.inverse|escape:'htmlall':'UTF-8'}">
