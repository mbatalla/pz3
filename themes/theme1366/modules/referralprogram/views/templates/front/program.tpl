...
<div class="sheets tab-content">
  <div id="idTab1" class="tab-pane active">
    ...
    {if $canSendInvitations}
      ...
      <form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" class="std">
        ...
        <p class="checkbox">
          <input type="checkbox" name="conditionsValided" id="conditionsValided" value="1" {if isset($smarty.post.conditionsValided) && $smarty.post.conditionsValided eq 1}checked="checked"{/if} />
  ...
  <div id="idTab2" class="tab-pane">
    {if $pendingFriends && $pendingFriends|@count > 0}
    ...
    {else}
      <p class="alert alert-warning">
        {if $subscribeFriends && $subscribeFriends|@count > 0}
  ...
  <div id="idTab3" class="tab-pane">
    {if $subscribeFriends && $subscribeFriends|@count > 0}
      <p>{l s='Here are sponsored friends who have accepted your invitation:' mod='referralprogram'}</p>
      <table class="table table-bordered">
        <thead>
          <tr>
            <th class="first_item">&nbsp;</th>
...
<ul class="footer_links clearfix">
  <li>
    <a class="btn btn-secondary btn-sm icon-left" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='referralprogram'}" rel="nofollow">
      <span>
  ...
  <li>
    <a class="btn btn-secondary btn-sm icon-left" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{l s='Home' mod='referralprogram'}">
      <span>
