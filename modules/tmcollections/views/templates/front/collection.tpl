          ...
          <div class="product_container">
            ...
            {if (!$PS_CATALOG_MODE)}
              ...
              {if $product.product_quantity >= 1}
                <a class="button ajax_add_to_cart_button btn btn-default" title="{l s='Add to cart' mod='tmcollections'}" data-id-product="{$product.id_product|intval}" href="{$link->getPageLink('cart', true, NULL, "")|escape:'html':'UTF-8'}" rel="nofollow">
              ...
              {/if}
            {/if}
            <a class="button lnk_view btn btn-default" href="{$link->getProductlink($product.id_product, $product.link_rewrite)|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" rel="nofollow">
