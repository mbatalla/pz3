...
<script type="text/javascript">
	...
	import_text['files_load_heading']= "{l s='Select what you want to load' mod='sampledatainstall'}";
	import_text['files_load_logos']= "{l s='Load logo' mod='sampledatainstall'}";
	import_text['files_load_content']= "{l s='Load content' mod='sampledatainstall'}";
	import_text['files_load_all']= "{l s='Load all content' mod='sampledatainstall'}";
	import_text['files_load_modules']= "{l s='Load modules' mod='sampledatainstall'}";
	import_text['files_load_confirm']= "{l s='Confirm' mod='sampledatainstall'}";
</script>
