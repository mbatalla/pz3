...
class Tmlookbook extends Module
{
    ...
    protected function renderPagesList()
    {
        ...
        $helper->toolbar_btn['export'] = array(
            'href' => $this->getTMLookBookLink('tmlookbook', array(), (int)Context::getContext()->language->id),
    ...
    protected function getLookBooksByIdProduct($id_product)
    {
        ...
        foreach ($tabs as $key => $tab) {
            $tabs[$key]['link'] = $this->getTMLookBookLink('tmlookbookpage_rule', array('id_page' => $tab['id_page']), (int)Context::getContext()->language->id);
        }
