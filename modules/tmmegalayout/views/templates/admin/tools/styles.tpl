...
<div class="form-wrapper tmmegalayout-styles">
    ...
    <ul class="nav nav-tabs">
        <li id="s-tab-1" class="active"><a class="layouts-tab" data-toggle="tab" href="#sitems-1">{l s='Background styles' mod='tmmegalayout'}</a></li>
        <li id="s-tab-2"><a class="layouts-tab" data-toggle="tab" href="#sitems-2">{l s='Border styles' mod='tmmegalayout'}</a></li>
        <li id="s-tab-3"><a class="layouts-tab" data-toggle="tab" href="#sitems-3">{l s='Other styles' mod='tmmegalayout'}</a></li>
    </ul>
                            ...
                            <div class="col-xs-12 background-settings-container col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="background-position">
                                        <option value=""></option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'center center'}selected="selected"{/if} value="center center">center center</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'center top'}selected="selected"{/if} value="center top">center top</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'center bottom'}selected="selected"{/if} value="center bottom">center bottom</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'left top'}selected="selected"{/if} value="left top">left top</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'left center'}selected="selected"{/if} value="left center">left center</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'left bottom'}selected="selected"{/if} value="left bottom">left bottom</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'right top'}selected="selected"{/if} value="right top">right top</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'right center'}selected="selected"{/if} value="right center">right center</option>
                                        <option {if isset($styles.background_position) && $styles.background_position == 'right bottom'}selected="selected"{/if} value="right bottom">right bottom</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="background-size">
                                        <option value=""></option>
                                        <option {if isset($styles.background_size) && $styles.background_size == 'contain'}selected="selected"{/if} value="contain">contain</option>
                                        <option {if isset($styles.background_size) && $styles.background_size == 'cover'}selected="selected"{/if} value="cover">cover</option>
                                        <option {if isset($styles.background_size) && $styles.background_size == 'auto'}selected="selected"{/if} value="auto">auto</option>
                                    </select>
                                </div>
                                <label class="uppercase">{l s='origin' mod='tmmegalayout'}</label>
                                <select name="background-origin">
                                    <option value=""></option>
                                    <option {if isset($styles.background_origin) && $styles.background_origin == 'border-box'}selected="selected"{/if} value="border-box">border-box</option>
                                    <option {if isset($styles.background_origin) && $styles.background_origin == 'content-box'}selected="selected"{/if} value="content-box">content-box</option>
                                    <option {if isset($styles.background_origin) && $styles.background_origin == 'padding-box'}selected="selected"{/if} value="padding-box">padding-box</option>
                                </select>
                            </div>
                        </div>
                    </div>
        ...
        <div id="sitems-2" class="tab-pane">
            <div class="clearfix border-settings">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <select name="border-top-style">
                            <option value=""></option>
                            <option {if isset($styles.border_top_style) && $styles.border_top_style == 'none'}selected="selected"{/if} value="none">none</option>
                            <option {if isset($styles.border_top_style) && $styles.border_top_style == 'dashed'}selected="selected"{/if} value="dashed">dashed</option>
                            <option {if isset($styles.border_top_style) && $styles.border_top_style == 'dotted'}selected="selected"{/if} value="dotted">dotted</option>
                            <option {if isset($styles.border_top_style) && $styles.border_top_style == 'double'}selected="selected"{/if} value="double">double</option>
                            <option {if isset($styles.border_top_style) && $styles.border_top_style == 'solid'}selected="selected"{/if} value="solid">solid</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="border-right-style">
                            <option value=""></option>
                            <option {if isset($styles.border_right_style) && $styles.border_right_style == 'none'}selected="selected"{/if} value="none">none</option>
                            <option {if isset($styles.border_right_style) && $styles.border_right_style == 'dashed'}selected="selected"{/if} value="dashed">dashed</option>
                            <option {if isset($styles.border_right_style) && $styles.border_right_style == 'dotted'}selected="selected"{/if} value="dotted">dotted</option>
                            <option {if isset($styles.border_right_style) && $styles.border_right_style == 'double'}selected="selected"{/if} value="double">double</option>
                            <option {if isset($styles.border_right_style) && $styles.border_right_style == 'solid'}selected="selected"{/if} value="solid">solid</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="border-bottom-style">
                            <option value=""></option>
                            <option {if isset($styles.border_bottom_style) && $styles.border_bottom_style == 'none'}selected="selected"{/if} value="none">none</option>
                            <option {if isset($styles.border_bottom_style) && $styles.border_bottom_style == 'dashed'}selected="selected"{/if} value="dashed">dashed</option>
                            <option {if isset($styles.border_bottom_style) && $styles.border_bottom_style == 'dotted'}selected="selected"{/if} value="dotted">dotted</option>
                            <option {if isset($styles.border_bottom_style) && $styles.border_bottom_style == 'double'}selected="selected"{/if} value="double">double</option>
                            <option {if isset($styles.border_bottom_style) && $styles.border_bottom_style == 'solid'}selected="selected"{/if} value="solid">solid</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="border-left-style">
                            <option value=""></option>
                            <option {if isset($styles.border_left_style) && $styles.border_left_style == 'none'}selected="selected"{/if} value="none">none</option>
                            <option {if isset($styles.border_left_style) && $styles.border_left_style == 'dashed'}selected="selected"{/if} value="dashed">dashed</option>
                            <option {if isset($styles.border_left_style) && $styles.border_left_style == 'dotted'}selected="selected"{/if} value="dotted">dotted</option>
                            <option {if isset($styles.border_left_style) && $styles.border_left_style == 'double'}selected="selected"{/if} value="double">double</option>
                            <option {if isset($styles.border_left_style) && $styles.border_left_style == 'solid'}selected="selected"{/if} value="solid">solid</option>
                        </select>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="form-group">
                        <label>{l s='top' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
                    ...
                    <div class="form-group">
                        <label>{l s='right' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
                    ...
                    <div class="form-group">
                        <label>{l s='bottom' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
                    ...
                    <div class="form-group">
                        <label>{l s='left' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="form-group">
                        <label>{l s='top right' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
                    ...
                    <div class="form-group">
                        <label>{l s='bottom right' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
                    ...
                    <div class="form-group">
                        <label>{l s='bottom left' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
                    ...
                    <div class="form-group">
                        <label>{l s='top left' mod='tmmegalayout'} <small><i>(px, em)</i></small></label>
