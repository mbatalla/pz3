...
class Tmmosaicproducts extends Module
{
    ...
    protected function updateTab()
    {
        ...
        foreach ($this->languages as $lang) {
            if (!Tools::isEmpty(Tools::getValue('custom_name_' . $lang['id_lang']))) {
                ...
                $tab->custom_name[$lang['id_lang']] = pSql(Tools::getValue('custom_name_' . $this->default_language['id_lang']));
            }
        }
    ...
    protected function checkTabFields()
    {
        ...
        if (!Validate::isName(Tools::getValue('custom_name_' . $this->default_language['id_lang']))) {
