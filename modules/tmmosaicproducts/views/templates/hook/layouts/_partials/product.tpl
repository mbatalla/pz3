  ...
  <div class="clearfix">
    {if !$PS_CATALOG_MODE}
      {if $product->quantity > 0}
        <a class="button ajax_add_to_cart_button btn btn-default" href="{$link->getPageLink('cart', true, NULL, "")|escape:'html':'UTF-8'}" rel="nofollow" data-id-product="{$product_id|intval}" title="{l s='Add to cart' mod='tmmosaicproducts'}">
