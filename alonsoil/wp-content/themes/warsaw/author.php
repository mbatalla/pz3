<?php warsaw_bunch_global_variable(); 
	...
	$layout = warsaw_set( $settings, 'author_page_layout', 'right' );
	$sidebar = warsaw_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
	$view = warsaw_set( $settings, 'author_page_view', 'list' );
	...
	$bg = warsaw_set($settings, 'author_page_header_img');
	$title = warsaw_set($settings, 'author_page_header_title');
?>
