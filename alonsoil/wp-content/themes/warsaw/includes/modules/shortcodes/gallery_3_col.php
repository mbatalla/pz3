...
ob_start();?>
	...
	?>
		...
		if( $post_terms ) foreach( $post_terms as $p_term ) $term_slug .= $p_term->slug.' ';?>		
           ...
           <div class="default-portfolio-item mix mix_all col-md-4 col-sm-6 col-xs-12 <?php echo esc_attr($term_slug); ?>">
                <div class="inner-box">
                    <figure class="image-box"><?php the_post_thumbnail('warsaw_370x340');?></figure>
        ...
        <div class="mixitup-gallery">
            ...
            <div class="filters text-center">
                <ul class="filter-tabs filter-btns clearfix">
                    ...
                    <li class="active filter" data-role="button" data-filter=".<?php echo esc_attr(warsaw_set( $t, 'slug' )); ?>"><?php echo balanceTags(warsaw_set( $t, 'name')); ?></li>
                    <?php endforeach;?>
                </ul>
            </div>
