...
ob_start();?>
	...
	?>
		...
		if( $post_terms ) foreach( $post_terms as $p_term ) $term_slug .= $p_term->slug.' ';?>		
           ...
           <div class="default-portfolio-item masonry-item all <?php echo esc_attr($term_slug); ?> <?php if(warsaw_set($meta1, 'extra_width') == 'extra_width') echo 'col-md-6 col-sm-12 col-xs-12'; elseif(warsaw_set($meta1, 'extra_height') == 'extra_height') echo 'col-md-6 col-sm-12 col-xs-12'; else echo 'col-md-3 col-sm-6 col-xs-12';?> ">
                <div class="inner-box">
                    <figure class="image-box">
                    	<?php if(warsaw_set($meta1, 'extra_width') == 'extra_width') 
							$image_size = 'warsaw_575x301'; 
						  elseif(warsaw_set($meta1, 'extra_height') == 'extra_height')
							$image_size = 'warsaw_575x620'; 
						  else
							$image_size = 'warsaw_278x300'; 
    ...
    <div class="auto-container">
        ...
        <div class="masonry-gallery">
            ...
            <div class="styled-pagination text-center">
                <?php warsaw_the_pagination(array('total'=>$query->max_num_pages, 'next_text' => '<span class="next">Next</span>', 'prev_text' => '<span class="prev">Previous</span>')); ?>
            </div>
