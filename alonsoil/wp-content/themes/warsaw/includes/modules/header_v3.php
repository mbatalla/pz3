    ...
    <div class="main-box">
        <div class="auto-container">
            <div class="outer-container clearfix">
                ...
                <div class="logo-box">
                    <div class="logo">
                    	<?php if(warsaw_set($options, 'logo_v3_image')):?>
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(warsaw_set($options, 'logo_v3_image'));?>" alt="" title="<?php esc_html_e('Warsaw', 'warsaw');?>"></a>
                        <?php else:?>
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(get_template_directory_uri().'/images/logo-5.png');?>" alt="<?php esc_html_e('Warsaw', 'warsaw');?>"></a>
                        <?php endif;?>
                    </div>
                </div>
